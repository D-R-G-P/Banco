    ...
    if ($statement->execute()) {
        ...
        if ($result) {
            ...
            if ($currentState !== 'act') {
                ...
                $updateQuery = "UPDATE itemssolicitables SET estado = 'act' WHERE id = :id";
                ...
                if ($updateStatement->execute()) {
                    $_SESSION['success_message'] = '<div class="notisContent"><div class="notis" id="notis">Item habilitado correctamente</div></div><script>setTimeout(() => {notis.classList.toggle("active");out();}, 1);function out() {setTimeout(() => {notis.classList.toggle("active");}, 2500);}</script>';
