      ...
      <div class="accordion-item">
        ...
        <div class="accordion-content">
          <form action="/Banco/app/profile/categoria.php" method="post">
            ...
            <label for="sigla">Banco al que pertenece</label>
            ...
            <button type="submit" class="btn-verde"><i class="fa-solid fa-plus"></i> Agregar categoria</button>
          </form>
        </div>
      </div>
    </div>
    ...
    <div class="datos">
      ...
      <div class="datos-contenido">
        <form action="/Banco/app/profile/modificar.php" method="post">
          ...
          <label for="password">Contraseña</label>
          <input type="password" name="password" value="1234" readonly>

          <label for="cargo">Cargo</label>
          <input type="text" name="cargo" required disabled>
          ...
          <button type="submit" class="btn-verde"><i class="fa-solid fa-plus"></i> Modificar datos</button>
        </form>
      </div>
    </div>
